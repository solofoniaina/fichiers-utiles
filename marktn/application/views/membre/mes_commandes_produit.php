		...
		<div class="tete-page">
			<div class="row">
				...
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					<titre>Ventes réalisées :</titre>
					<BR><br>
						<?php
						$achat = $this->Vente_model->commandes_recu_membre_article($id_membre);
						$somme = 0;
						...
						<div class="row achat attente">
							<div class="col-md-6 produit">
								...
								<h5>Prix Unitaire : <b><?php echo $pack['prix_v'] ?> MGA</b></h5>
								<h5>Quantité : <b><?php echo $pack['nombre_v'] ?></b></h5>
								<h5>Total : <b><?php echo $montant = $pack['prix_v'] * $pack['nombre_v'] ?> MGA</b></h5>
							...
							<div class="col-md-6 vendeur">
								...
								$etat_reception = "";
								 ...
								 if ($pack['paye_v'] == 1) { 
								 	$etat_paiement = "ok";
								 	?>
									<h4><span class="glyphicon glyphicon-user"></span> Acheteur</h4>
									<h5>Nom : <b><?php echo $pack['nom_m']. " " . $pack['prenom_m'] ?></b></h5>
									<h5>Prénom : <b><?php echo  $pack['nom_a'] ?></b></h5>
								...
								<?php } ?>
								<span id="commande_paiement" class="commande <?php echo $etat_paiement ?>"> Payé </span>
								<span id="commande_livraison" class="commande <?php echo $etat_livraison ?>"> Vérifié </span>
								<span id="commande_reception" class="commande <?php echo $etat_reception ?>"> Reçu </span>
							</div>
							...
							{
							 ?>
							 <div class="row achat attente" align="center">-- Vous n'avez pas encore réalisé des ventes --</div>
							 <?php
							}
							 ?>
				</div>
