			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="formulaire login">
						<h4>Un message a été envoyé à l'adresse e-mail <b><?php echo $email ?></b>. <br> Pour confirmer votre inscription, vérifier votre boite de réception et cliquer sur le lien envoyé.</h4>
					</div>
				</div>
