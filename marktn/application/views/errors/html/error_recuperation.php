...
<head>
	...
	<title>	Cybar | Erreur de confirmation</title>
	...
	<div>
		...
		<div class="tete">
			<div class="row">
				...
				<div class="col-md-4">
					<img src="<?php echo base_url() ?>assets/images/logo.png" title="logo Cybar" alt="logo Cybar" style="height: 170px">
					<div class="formulaire login">
						<h4>Désolé,</h4>
						<h4>le lien de récupération ne fonctionne plus.</h4>
						 <a href="<?php echo base_url() ?>connexion/recuperation"><h4>Vous voulez changer votre mot de passe ?</h4></a>
					</div>
				</div>
