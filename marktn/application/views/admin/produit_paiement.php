	...
	<div>
		...
		<div class="tete-page">
			<div class="row">
				...
				<div class="col-md-2 place_menu" align="center" style="padding-top: 50px">
					<!--sous menu -->
					<?php $this->load->view('template/sous_menu_admin') ?>
					
				</div>
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					<titre>En attente paiement :</titre>
					<BR><br>
					<div class="row section_recherche">
						<div class="col-md-6">
							<div style="margin-top: 23px;">
								<input onkeyup="chercher_paiement_produit()" id="user_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche utilisateur"> 	
							</div>
						</div>
						<div class="col-md-6">
							<div style="margin-top: 23px;" class="input-group">
								<input onkeyup="chercher_paiement_produit()" id="produit_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche produits">
					...
					<div id="result_recherche" align="center">
						...
						$achat = $this->Admin_model->achat_article_paye_livre(0,0,0);
						$somme = 0;
							foreach ($achat as $key => $pack) {
						?>

						<div class="row achat nok" align="left">
							<div class="col-md-6 produit">
								...
								<table class="table table-bordered">
									...
									<tr>
										<td class="cell header">Client (<?php echo 100 - $p['notre_commission'] ?> %)</td>
										<td class="cell header">Comm. (<?php echo $p['notre_commission'] ?> %)</td>
									</tr>
									<tr>
										<td class="cell"><?php echo $cli = $montant * (100 - $p['notre_commission']) / 100 ?></td>
							...
							<div class="col-md-6 vendeur">
								...
								<?php }
									...
									$etat_livraison = "ok";
									  ?>
									Payé <span class="glyphicon glyphicon-ok"></span> - <button id="btn_action_<?php echo $pack['id_vente'] ?>" class="btn btn-default" onclick="produit_marquer_livrer(<?php echo $pack['id_vente'] ?>)">Marquer Livré</button>
								<?php }else{ ?>
									Payé <span class="glyphicon glyphicon-ok"></span> - Livré <span class="glyphicon glyphicon-ok"></span>
								<?php }
									} ?>
