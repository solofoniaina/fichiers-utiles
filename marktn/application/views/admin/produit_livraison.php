	...
	<div>
		...
		<div class="tete-page">
			<div class="row">
				...
				<div class="place_menu col-md-2" align="center" style="padding-top: 50px">
					<!--sous menu -->
					<?php $this->load->view('template/sous_menu_admin') ?>
					
				</div>
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					<titre>En attente livraison :</titre>
					<BR><br>
					<div class="row section_recherche">
						<div class="col-md-6">
							<div style="margin-top: 23px;">
								<input onkeyup="chercher_livraison_produit()" id="user_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche utilisateur"> 	
							</div>
						</div>
						<div class="col-md-6">
							<div style="margin-top: 23px;" class="input-group">
								<input onkeyup="chercher_livraison_produit()" id="produit_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche produits">
					...
					<div id="result_recherche" align="center">
						...
						$achat = $this->Admin_model->achat_article_paye_livre(1,0,0);
						$somme = 0;
