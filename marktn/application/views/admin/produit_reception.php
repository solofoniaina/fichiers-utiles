		...
		<div class="tete-page">
			<div class="row">
				...
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					<titre>En attente reception :</titre>
					<BR><br>
					<div class="row section_recherche">
						<div class="col-md-6">
							<div style="margin-top: 23px;">
								<input onkeyup="chercher_reception_produit()" id="user_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche utilisateur"> 	
							</div>
						</div>
						<div class="col-md-6">
							<div style="margin-top: 23px;" class="input-group">
								<input onkeyup="chercher_reception_produit()" id="produit_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche produits">
					...
					<div id="result_recherche" align="center">
						<?php
						$achat = $this->Admin_model->achat_article_paye_livre(1,1,0);
						$somme = 0;
