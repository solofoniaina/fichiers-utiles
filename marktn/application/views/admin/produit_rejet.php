		...
		<div class="tete-page">
			<div class="row">
				...
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					<titre>Commandes rejetées :</titre>
					<BR><br>
					<div class="row section_recherche">
						<div class="col-md-6">
							<div style="margin-top: 23px;">
								<input onkeyup="chercher_rejet_produit()" id="user_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche utilisateur"> 	
							</div>
						</div>
						<div class="col-md-6">
							<div style="margin-top: 23px;" class="input-group">
								<input onkeyup="chercher_rejet_produit()" id="produit_srch" type="text" class="form-control" name="key" value="" placeholder="Recherche produits">
					...
					<div id="result_recherche" align="center">
						<?php
						$achat = $this->Admin_model->achat_article_paye_livre(1,2,0);
						$somme = 0;
							foreach ($achat as $key => $pack) {
						?>

						<div class="row achat ko" align="left">
							...
							<div class="col-md-6 vendeur">
								...
								<table class="table table-bordered">
									<tr>
										...
										<td id="commande_livraison"  class="commande ko">Vérifié</td>
										<td id="commande_reception"  class="commande ">Reçu </td>
									</tr>
									<tr>
