		...
		<div class="tete-page">
			<div class="row">
				...
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					...
					<titre>Les nouvelles inscriptions</titre>
					<?php 
						$log = $this->Admin_model->get_log_insc();

					?>
					<BR><br>
					<table class="table table-bordered">
						<tr>
							<th>Date inscription</td>
						...
						<tr id="tr_<?php echo $key ?>">
							<td><?php echo $l['date_m'] ?></td>
							<td><?php echo $l['nom_m']." ".$l['prenom_m'] ?></td>
							<td style="text-align: right;"><button id="btn_<?php echo $key ?>" class="btn btn-warning" onclick="script_parrain(<?php echo $l['id_membre'] ?>, <?php echo $key ?>)">Lancer script</button></td>
						</tr>
						<?php } ?>
					</table>
				</div>
