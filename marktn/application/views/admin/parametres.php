			...
			<div class="row">
				...
				<div class="col-md-8" style="overflow: auto;padding-top: 50px" id="droite">
					...
					<?php 
					 ...
					 ?>
					<BR><br>
					<div class="resume" style="background-color: #fff; padding: 32px; font-size: 16px;}">
					<form method="POST" action="<?php echo base_url() ?>index.php/admin/update_parametres">
						...
						<input type="hidden" class="form-control" value="<?php echo $p['gain_public'] ?>" name="gain_public" id="gain_public">
						<input type="hidden" class="form-control" value="<?php echo $p['gain_membre'] ?>" name="gain_membre" id="gain_membre">
						<input type="hidden" class="form-control" value="<?php echo $p['gain_referral'] ?>" name="gain_referral" id="gain_referral">
						<input type="hidden" class="form-control" value="<?php echo $p['gain_referral_free'] ?>" name="gain_referral_free" id="gain_referral_free">
						<input type="hidden" class="form-control" value="<?php echo $p['droit_inscription'] ?>" name="droit_inscription" id="droit_inscription">
						<input type="hidden" class="form-control" value="<?php echo $p['minimum_retrait'] ?>" name="minimum_retrait" id="minimum_retrait">
						<input type="hidden" class="form-control" value="<?php echo $p['bonus_abonnement'] ?>" name="bonus_abonnement" id="bonus_abonnement">


						<div class="row">
							<div class="col-md-5">
								<label>Commission ventes ( % )</label>
