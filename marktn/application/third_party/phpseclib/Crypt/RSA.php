...
// echo APPPATH.'third_party/phpseclib/Crypt/';
// echo count(glob(dirname(__FILE__) .APPPATH.'/third_party/phpseclib/Crypt/*.php'));

// foreach( glob(dirname(__FILE__) .APPPATH.'third_party/phpseclib/Crypt/*.php') as $class_path ) {
	// echo 'test';
